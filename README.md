...
- [Problem description and idea](/docs/general_idea.md)
   
- [Basic architecture](/docs/general_basic_architecture.md)

- [Domain dictionary](/docs/general_domain_dictionary.md)

- [Use-cases](/docs/general_use_cases.md)

#### 2. Supported data sources:

- [Test data source (sandbox)](/docs/supported_data_sources_test_data_source.md)
