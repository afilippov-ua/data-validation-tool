...
public class ColumnPairTest extends AbstractTest {
    ...
    void shouldThrowAnExceptionInCaseOfIncorrectInput(TablePair tablePair, String id, String name,
        ...
        assertThatThrownBy(() -> new ColumnPair(id, name, tablePair, leftDatasourceColumn, rightDatasourceColumn, leftTransformer, rightTransformer))
