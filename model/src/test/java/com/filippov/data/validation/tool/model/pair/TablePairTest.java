...
public class TablePairTest extends AbstractUnitTest {
    ...
    void shouldThrowAnExceptionInCaseOfIncorrectInput(String id, String name, ColumnPair keyColumnPair,
        ...
        Assertions.assertThatThrownBy(() -> new TablePair(id, name, keyColumnPair, leftDatasourceTable, rightDatasourceTable))
