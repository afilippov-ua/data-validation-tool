...
public class TestJsonDatasource implements Datasource {
    private final TestJsonDatasourceConfig datasourceConfig;
    ...
    @Override
    public TestJsonDatasourceConfig getConfig() {
    ...
    public String toString() {
        return "TestJsonDatasource(datasourceConfig=" + this.datasourceConfig + ")";
    }

    private DatasourceMetadata loadMetadata() {
        return new TestJsonDataLoader().loadData(datasourceConfig.getMetadataFilePath(), new TypeReference<>() {
        });
    }
    ...
    private Map<DatasourceColumn, ColumnData<?, ?>> loadData() {
        ...
        final Map<String, Map<String, ColumnData<?, ?>>> data = new TestJsonDataLoader()
