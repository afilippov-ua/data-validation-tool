...
@Getter
@ToString
public class TestJsonDatasourceConfig implements DatasourceConfig {
    ...
    TestJsonDatasourceConfig(String metadataFilePath, String dataFilePath, int maxConnections) {
    ...
    public static TestJsonDatasourceConfigBuilder builder() {
        return new TestJsonDatasourceConfigBuilder();
    }
